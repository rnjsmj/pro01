	...
	<section class="page" id="page1">
		...
		<div style="width:960px; margin:0 auto;">
			...
			<div class="form-check">
				<input type="checkbox" class="form-check-input" id="ck_item1" name="ck_item1" onClick="ck_option()">
			...
			<div class="form-check">
				<input type="checkbox" class="form-check-input" id="ck_item2" name="ck_item2" onClick="ck_option()">
				<label for="ck_item2" class="form-check-label"> 위 개인정보처리방침에 동의합니다.</label>
			</div>
			
			<div  style="margin:20px;">
			  <input type="checkbox" class="form-check-input" id="ck_all" name="ck_all" onClick="all_check()">
			  <label for="ck_all" class="form-check-label">전체 약관에 동의합니다.</label>
			</div>
			<div class="btn-group">  
		...
		function term_check(){
			if(ck_item1.checked && ck_item2.checked){
				...
				alert("회원약관 및 개인정보처리방침에 동의하지 않으셨습니다.");
				return;
			}
		}
		</script>
