...
.table th { text-align:right; width:130px;}
...
<div id="contents" >
	<section class="page" id="page1">
		...
		<h3 class="page_title">교통편 안내</h3>
			<div class="div_table">
			<form action="${path0 }/TrafficUpdatePro.do" method="post">
				<table class="table">
					<tbody>
						<tr>
							<th><label for="ttype">교통편 종류</label></th>
							<td>
								<input type="hidden" name="tno" id="tno" value="${traffic.tno }">
								<input type="text" name="ttype" id="ttype" class="form-control" maxlength="50" value="${traffic.ttype }" required>
							</td>
						</tr>
						<tr>
							<th><label for="no">번호 | 선</label></th>
							<td>
								<input type="text" name="no" id="no" class="form-control" maxlength="50" value="${traffic.no }" required>
							</td>
						</tr>
						<tr>
							<th><label for="comm">운행목적</label></th>
							<td>
								<input type="text" name="comm" id="comm" class="form-control" maxlength="50" 
									placeholder="버스의 경우 간선/지선/시내/광역/마을/심야 중 하나를 입력하시오" value="${traffic.comm }"> 
							</td>
						</tr>
						<tr>
							<th><label for="content">경로</label></th>
							<td>
								<textarea name="route" id="route" rows="8" cols="80" class="form-control" required>${traffic.route }</textarea>
							</td>
						</tr>
					</tbody>
				</table>
